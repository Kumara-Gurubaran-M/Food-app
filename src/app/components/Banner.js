      ...
      <div className="container mx-auto min-h-[768px] flex items-center justify-center">
        ...
        >
          ...
          <MouseParallaxChild factorX={0.2} factorY={0.3} className="relative">
            <div className="flex flex-col lg:flex-row items items-center text-center lg:text-left flex-1 px-6 ">
              <div className="flex-1 flex justify-end max-w-sm lg:max-w-max">
                <Image src={'/pizza-banner.png'} width={550} height={558} alt="pizza" priority={1} />
              </div>
            </div>
            <MouseParallaxChild factorX={0.2} factorY={0.3} className="absolute top-6 left-4 hidden xl:flex">
              <Image src={'/chilli-1.png'} width={160} height={84} alt='chilli-1' priority={1} />
            </MouseParallaxChild>

            <MouseParallaxChild factorX={0.4} factorY={0.4} className="absolute top-16 -left-4 hidden xl:flex">
              <Image src={'/chilli-2.png'} width={130} height={84} alt='chilli-2' priority={1} />
            </MouseParallaxChild>

            <MouseParallaxChild factorX={0.6} factorY={0.6} className="absolute top-80 -left-24 hidden xl:flex">
              <Image src={'/garlic-1.png'} width={130} height={84} alt='chilli-3' priority={1} />
            </MouseParallaxChild>

            <MouseParallaxChild factorX={0.3} factorY={0.6} className="absolute top-[22rem] -left-8 hidden xl:flex">
              <Image src={'/garlic-2.png'} width={100} height={72} alt='garlic-2' priority={1} />
            </MouseParallaxChild>

            <MouseParallaxChild factorX={0.4} factorY={1} className="absolute top-96 -left-20 hidden xl:flex">
              <Image src={'/garlic-3.png'} width={100} height={72} alt='garlic-2' priority={1} />
            </MouseParallaxChild>

            <MouseParallaxChild factorX={0.2} factorY={0.2} className="absolute top-96 -left-0 hidden xl:flex">
              <Image src={'/leaves.png'} width={180} height={72} alt='garlic-2' priority={1} />
            </MouseParallaxChild>
          </MouseParallaxChild>
        </MouseParallaxContainer>
      </div>
